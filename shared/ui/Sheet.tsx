...
export function Sheet({
  ...
  return (
    ...
    >
      <div
        className={`fixed inset-x-0 bottom-0 max-h-[92vh] overflow-hidden rounded-t-[22px] border-t border-line bg-bg transition-transform duration-300 ease-[cubic-bezier(.32,.72,0,1)] ${
